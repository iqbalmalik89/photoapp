  ...
  <div class="modal-dialog" style="width:1000px;">
    <div class="modal-content" style="width:1000px;">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><span id="mode">Add </span> Portfolio</h4>
      </div>
         ...
         <!--col-md-12 start-->
          <div class="col-md-12">
            <div class="page-heading">
              <h1>Portfolio  <button type="button" data-toggle="modal" data-target="#addportfolio" onclick="showAddPortfolioPopup();" class="btn btn-primary">Add Portfolio</button>  </h1>
            </div>
